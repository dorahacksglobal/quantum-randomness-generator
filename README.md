...
| ---------------- | ----------- |
| $(a_i, b_i) = (0, 0)$ | ![](./README_pic/a0b0_circuit.png | width = 400) |
| $(a_i, b_i) = (0, 1)$ | ![](./README_pic/a0b1_circuit.png | width = 400) |
| $(a_i, b_i) = (1, 0)$ | ![](./README_pic/a1b0_circuit.png | width = 400) |
| $(a_i, b_i) = (1, 1)$ | ![](./README_pic/a1b1_circuit.png | width = 400) |
